...
def euclidean_dist(nNode, initLoc):
    ...
    for row in range(size):
        for col in range(size):
            ...
            if val == 0:
                ...
                dx1 = row - r_row
                dy1 = col - r_col
                dx2 = initLoc[val][0] - r_row
                dy2 =  initLoc[val][0] - r_col
...
class Puzzle(object):
    ...
    def generate_neighbours(self, cNode, visited, initLoc):
    ...
    def solve(self):
        ...
        for i in range(size):
            for j in range(size):
                if self.init_state[i][j] != 0:
                    initLoc[self.init_state[i][j]] = [i, j]
        ...
        while frontier:
            ...
            if search_state_str == goal_state_str:
                ...
                neighbours = self.generate_neighbours(cNode, visited, initLoc)
