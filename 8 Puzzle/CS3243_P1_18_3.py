    ...
    for row in range(size):
        for col in range(size):
            ...
            if val == 0:
                ...
                r_row = (val - 1) // size
                r_col = (val - 1) % size
            heuristic += abs(r_row - row) + abs(r_col - col)
    return heuristic
#endregion
...
class Puzzle(object):
    ...
    def solve(self):
        ...
        mNode.f = manhattanDistance(mNode) + g[initState]
            ...
            if current_state == self.goal_state:
                ...
                for nNode in neighbours:
                    ...
                    if parsed_state not in g or g[current_parsed_state] + 1 < g[parsed_state]:
                        ...
                        nNode[0].f = g[parsed_state] + manhattanDistance(nNode[0])
